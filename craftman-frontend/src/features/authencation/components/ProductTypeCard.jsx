...
export default function ProductTypeCard({ image, name, description, product }) {
  // console.log("id :", id)

  const navgate = useNavigate();
  const handleClickProduct = () => {
    navgate(`/product/${product.name}`);
  };
  console.log(product);
  return (
    <div className="flex flex-col justify-center items-center w-[200px] mb-4">
      ...
      <div className="font-bold mt-1 text-amber-500 text-1xl"> ชื่อเบียร์ : {name}</div>
